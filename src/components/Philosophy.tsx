      ...
      <div className="philosophy-content max-w-4xl mx-auto backdrop-blur-2xl bg-slate-900/70 border border-teal-500/30 p-12 md:p-20 rounded-[3rem] shadow-[0_30px_60px_-15px_rgba(0,0,0,0.5),inset_0_1px_1px_rgba(255,255,255,0.1)] relative overflow-hidden">
        ...
        <div className="space-y-8 relative z-10">
          <p className="text-xl text-slate-300 leading-relaxed">
            <span className="font-semibold text-teal-300">Engineering is a team sport.</span> I believe in natural leadership—scaling teams by actively mentoring, establishing robust documentation, and cultivating genuine friendships that extend far beyond the workplace. 
          </p>
          <p className="text-xl text-slate-300 leading-relaxed">
